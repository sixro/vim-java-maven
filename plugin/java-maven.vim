...
function! <SID>MvnSetup()
  ...
  let b:mvnSourceDirectory = substitute(s:getParam(b:mvnPomFile, "project.build.sourceDirectory", "./src/main/java"), b:mvnPomDirectory, ".", "")
  let b:mvnTestSourceDirectory = substitute(s:getParam(b:mvnPomFile, "project.build.testSourceDirectory", "./src/test/java"), b:mvnPomDirectory, ".", "")
